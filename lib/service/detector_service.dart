...
class Detector {
  static const String _modelPath = 'assets/models/tiny-76.tflite';
  static const String _labelPath = 'assets/models/tiny-76.txt';
    ...
    final imageMatrix = List.generate(
      3,
          ...
          return List.generate(
              imageInput.height,
                  (j) {
                final pixel = imageInput.getPixel(j, x);
                if(y ==0){
                  return pixel.rNormalized;
                }else if(y==1){
                  return pixel.gNormalized;
                }
                else if(y==2){
                  return pixel.bNormalized;
                }
